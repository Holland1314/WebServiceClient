 ...
 * 
 */
@WebServiceClient(name = "WebServiceImplService", targetNamespace = "http://webService.example/", wsdlLocation = "http://localhost:8989/WS_Server/WebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICEIMPLSERVICE_QNAME = new QName("http://webService.example/", "WebServiceImplService");
    ...
    public WebServiceImpl getWebServiceImplPort() {
        return super.getPort(new QName("http://webService.example/", "WebServiceImplPort"), WebServiceImpl.class);
    }
    ...
    public WebServiceImpl getWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webService.example/", "WebServiceImplPort"), WebServiceImpl.class, features);
    }
